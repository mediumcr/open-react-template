      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <div className="inline-flex text-sm font-semibold py-1 px-3 m-2 text-green-600 bg-green-200 rounded-full mb-4">Create Software That Matters</div>
            <h1 className="h2 mb-4">One Team, unlimited solutions</h1>
            <p className="text-xl text-gray-400">Our commitment to meeting project deadlines and staying on schedule ensures smooth execution and customer satisfaction.</p>
          </div>
